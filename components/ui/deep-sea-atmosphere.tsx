...
const fragmentShader = `
  ...
  void mainImage(out vec4 fragColor, in vec2 fragCoord) {
      ...
      vec3 secondaryColor = vec3(0.1, 0.5, 0.4);
...
export const DeepSeaAtmosphere: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 w-full h-full overflow-hidden pointer-events-none z-0 bg-[#010816]">
            ...
            <div className="absolute inset-0 bg-[#010816]/30 mix-blend-multiply pointer-events-none" />
        </div>
    );
};
